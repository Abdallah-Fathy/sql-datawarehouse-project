/*
=====================================================================================
Stored Procedures: Load Brinze Layer (Source -> Bronze)
=====================================================================================
Script Purpose:
  This srored proceedure loads data into the 'bronze' schema from external CSV files.
  It performs the following actions :
  - Truncate the bronze tables before loading data
  - Uses the 'BULK INSERT' command to load data from csv Files to brinze tables.

Parameters: 
  None.
  This stored procedre does not accept any parameters or return any values.
...
BEGIN
	...
	BEGIN TRY
		...
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK  -- It lock the table when the sql server load the data in it 
		);
